      ...
      <div class="col-lg-12 d-flex justify-content-center align-items-center row">
            ...
            @foreach ($estudiantes as $estudiantes)
             ...
             <div class="tajetica">
                  <div>
                    <div class="info">
                      <h3><strong>ID: {{ $estudiantes->id }}</strong></h3>
                      <h4><strong>{{ $estudiantes->nombre }}</strong></h4>
                      <h4><strong>{{ $estudiantes->habilidades }}</strong></h4>
                    </div>
                    <div class="mb-3">
                      <h5>Acciones</h5>
                      <div class="botones"> 
                        <a href="estudiantes/editar/{{ $estudiantes->id }}" class="btn-actualizar">Editar</a>
                        <a href="estudiantes/borrar/{{ $estudiantes->id }}" class="btn-borrar">Borrar</a>
                      </div>
                    </div>
                  </div>
              </div>';
