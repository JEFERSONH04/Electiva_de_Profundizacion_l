      ...
      <div class="col-lg-12 d-flex justify-content-center align-items-center row">
            ...
            @foreach ($empresas as $empresas)
             ...
             <div class="tajetica">
                  <div>
                    <div class="info">
                      <h3><strong>ID: {{ $empresas->id }}</strong></h3>
                      <h4><strong>{{ $empresas->nombre }}</strong></h4>
                      <h4><strong>{{ $empresas->nit }}</strong></h4>
                    </div>
                    <div class="mb-3">
                      <h5>Acciones</h5>
                      <div class="botones"> 
                        <a href="empresas/editar/{{ $empresas->id }}" class="btn-actualizar">Editar</a>
                        <a href="empresas/borrar/{{ $empresas->id }}" class="btn-borrar">Borrar</a>
                      </div>
                    </div>
                  </div>
              </div>';
