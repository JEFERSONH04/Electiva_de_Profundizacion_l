  ...
  <div class="container">
    ...
    <div class="row  rounded-4 text-center">
      <div class="col-lg-12 d-flex justify-content-center align-items-center row">
            ...
            <?php $__currentLoopData = $tutores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutores): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

             <div class="tajetica">
                  <div>
                    <div class="info">
                      <h3><strong>ID: <?php echo e($tutores->id); ?></strong></h3>
                      <h4><strong><?php echo e($tutores->nombres); ?></strong></h4>
                      <h4><strong><?php echo e($tutores->apellidos); ?></strong></h4>
                    </div>
                    <div class="mb-3">
                      <h5>Acciones</h5>
                      <div class="botones"> 
                        <a href="tutores/editar/<?php echo e($tutores->id); ?>" class="btn-actualizar">Editar</a>
                        <a href="tutores/borrar/<?php echo e($tutores->id); ?>" class="btn-borrar">Borrar</a>
                      </div>
                    </div>
                  </div>
              </div>';
...
</html><?php /**PATH C:\xampp\htdocs\laravel\example-app\resources\views/Tutores/tutores.blade.php ENDPATH**/ ?>