...
<body>
  <div class="container">
    ...
    <h2 class="text-center pt-3 font-family text-light fs-1">Empresas</h2>
    <div class="row">
      <div class="col-lg-12">
        <a href="empresas/registro" class="btn-nuevo">Nueva empresa</a>
      ...
      <div class="col-lg-12 d-flex justify-content-center align-items-center row">
            ...
            <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empresas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             ...
             <div class="tajetica">
                  <div>
                    <div class="info">
                      <h3><strong>ID: <?php echo e($empresas->id); ?></strong></h3>
                      <h4><strong><?php echo e($empresas->nombre); ?></strong></h4>
                      <h4><strong><?php echo e($empresas->nit); ?></strong></h4>
                    </div>
                    <div class="mb-3">
                      <h5>Acciones</h5>
                      <div class="botones"> 
                        <a href="empresas/editar/<?php echo e($empresas->id); ?>" class="btn-actualizar">Editar</a>
                        <a href="empresas/borrar/<?php echo e($empresas->id); ?>" class="btn-borrar">Borrar</a>
                      </div>
                    </div>
                  </div>
              </div>';
...
</html><?php /**PATH C:\xampp\htdocs\laravel\example-app\resources\views/Empresas/tabla.blade.php ENDPATH**/ ?>